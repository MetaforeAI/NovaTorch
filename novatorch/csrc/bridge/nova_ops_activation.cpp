...
at::Tensor nova_sigmoid_backward(
    ...
    TORCH_CHECK(
        ...
        "nova_sigmoid_backward: only float32 supported");
    ...
    dispatchCompute(
        "sigmoid_backward", 3, sizeof(pc), &pc, bufs, sizes, groups, 1, 1,
...
at::Tensor& nova_sigmoid_backward_grad_input(
    ...
    auto result = nova_sigmoid_backward(grad_output, output);
